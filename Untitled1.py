...
data = pd.read_csv("C://Users//vaish//insurance.csv")
...
# Load the dataset
customer_data = pd.read_csv("E://Users//vaish//Downloads//archive (3)//shopping_trends.csv")
...
data = pd.read_csv("C://Users//vaish//shopping_trends_updated.csv")
