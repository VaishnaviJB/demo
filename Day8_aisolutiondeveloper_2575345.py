...
df = pd.read_csv("C://Users//vaish//Wine.csv")
df
...
plt.imshow(plt.imread("C://Users//vaish//Pictures//Screenshots//v2.png"))
...
try:
    raw_df = pd.read_csv("C://Users//vaish//heart_failure_clinical_records_dataset.csv")
except:
...
df = pd.read_csv("C://Users//vaish//heart (1).csv")
...
iris_ds= pd.read_csv("C://Users//vaish//Iris.csv")
